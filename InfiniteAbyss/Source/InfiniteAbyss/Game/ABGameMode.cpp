...
{
	static ConstructorHelpers::FClassFinder<APawn> DefaultPawnClassRef(TEXT("/Script/Engine.Blueprint'/Game/InfiniteAbyss/Blueprint/BP_ABCharacterPlayer.BP_ABCharacterPlayer_C'"));
